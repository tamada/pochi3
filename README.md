...
[![Version](https://img.shields.io/badge/Version-v3.0.0--alpha--13-green.svg)](https://github.com/tamada/pochi3/releases/tag/v3.0.0-alpha-13)
...
* `3.0.0-alpha-13`
  * `3.0.0-alpha-13-distroless`, `3.0.0-alpha-13`, `distroless`, `latest`
  * `3.0.0-alpha-13-fullgrl` `fullgrl`
  * `3.0.0-alpha-13-minimalgrl`, `minimalgrl`
