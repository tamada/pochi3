...
[![Version](https://img.shields.io/badge/Version-v3.0.0--alpha--18-green.svg)](https://github.com/tamada/pochi3/releases/tag/v3.0.0-alpha-18)
...
* `3.0.0-alpha-18`
  * `3.0.0-alpha-18-distroless`, `3.0.0-alpha-18`, `distroless`, `latest`
  * `3.0.0-alpha-18-fullgrl` `fullgrl`
  * `3.0.0-alpha-18-minimalgrl`, `minimalgrl`
